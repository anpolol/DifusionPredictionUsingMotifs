...
def find_motifs(graphs, ms_max=8,  # Только для сэмплирования
                diff_types=True, inp=10):  # возвращает motifs f1 И f3. Разделение на разные типы мотивов. Размеры мотивов 3 и 4
