...
#supernoder imports
from  SuperNoder_diff_types.enumerator import *
from  SuperNoder_diff_types.disjoint_motifs_finder import *
from  SuperNoder_diff_types.counter import *

class Manager:
	TOOL_NAME = 'SUPERNODER motifs of different types'
	...
	def __cut(self): #тут подсчитываем именно отдельные мотивы,
